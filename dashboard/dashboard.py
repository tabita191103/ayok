...
days_df = pd.read_csv(r"C:\FOLDER KULIAH\DOKUMEN STUPEN\PYTHON\dashboard\day_clean.csv")
hours_df = pd.read_csv(r"C:\FOLDER KULIAH\DOKUMEN STUPEN\PYTHON\dashboard\hour_clean.csv")
